...
@section('title', 'Edit Data Tambak')
@section('content')
<div class="card">
    <div class="card-body">
        <form method="POST" action="{{ route('tambak.update', $tambak->id_tambak) }}" class="form-horizontal" enctype="multipart/form-data" id="editTambak">
            @csrf
            @method('PUT')
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="nama_tambak" name="nama_tambak"
                            placeholder="Masukkan nama tambak" value="{{ old('nama_tambak', $tambak->nama_tambak) }}" required autofocus>
                        @error('nama_tambak')
                        ...
                        <div class="form-group">
                            <select class="choices form-select @error('id_gudang') is-invalid @enderror" name="id_gudang"
                                ...
                                @foreach ($gudang as $item)
                                    <option value="{{ $item->id_gudang }}" {{ $item->id_gudang == $tambak->id_gudang ? 'selected' : '' }}>
                                        {{ $item->nama }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="luas_lahan" name="luas_lahan"
                            placeholder="Masukkan luas lahan" value="{{ old('luas_lahan', $tambak->luas_lahan) }}" required>
                        @error('luas_lahan')
                        <div class="invalid-feedback">
                            <i class="bx bx-radio-circle"></i>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="luas_tambak" name="luas_tambak"
                            placeholder="Masukkan luas tambak" value="{{ old('luas_tambak', $tambak->luas_tambak) }}" required>
                        @error('luas_tambak')
                        <div class="invalid-feedback">
                            <i class="bx bx-radio-circle"></i>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="lokasi_tambak" name="lokasi_tambak" rows="3" placeholder="Masukkan Lokasi Tambak" required>{{ old('lokasi_tambak', $tambak->lokasi_tambak) }}</textarea>
                        @error('lokasi_tambak')
                        <div class="invalid-feedback">
                            <i class="bx bx-radio-circle"></i>
                ...
                <div class="col-md-6 d-flex justify-content-center align-items-center">
                    <div class="form-group">
                        <div class="col">
                            ...
                            @if ($tambak->foto)
                                <div class="row mt-3">
                                    <img src="{{ asset('storage/' . $tambak->foto) }}" alt="Foto Tambak" width="100">
                                </div>
                            @endif
                        </div>
                    </div>
            ...
            <div class="d-flex justify-content-between">
                <button type="button" class="btn btn-sm btn-danger"
                    onclick="window.location.href='{{ route('tambak.index') }}'"
