    ...
    <div class="card">
        <div class="card-body">
            @empty($alat)
                ...
                <button type="button" class="btn btn-sm btn-danger" onclick="window.location.href='{{ url('kelolaAlat') }}'"
                    style="background-color: #DC3545; border-color: #DC3545" id="btn-kembali">Kembali</button>
            @else
                <form method="POST" action="{{ url('/kelolaAlat/' . $alat->id_alat) }}" class="form-horizontal"
                    enctype="multipart/form-data" id="editAlat">
                        ...
                        <div class="col-md-6 mt-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('nama') is-invalid @enderror" id="nama"
                                    name="nama" value="{{ old('nama', $alat->nama) }}" placeholder="Masukkan Nama Alat"
                                    required autofocus>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('harga_satuan') is-invalid @enderror"
                                    id="harga_satuan" name="harga_satuan" value="{{ old('harga_satuan', $alat->harga_satuan) }}"
                                    placeholder="Masukkan Harga Satuan Alat" required>
                                <p><small class="text-muted">Wajib Diisi!</small></p>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <select class="choices form-select @error('satuan') is-invalid @enderror" name="satuan"
                                        ...
                                        <option value="Buah" {{ old('satuan', $alat->satuan) == 'Buah' ? 'selected' : '' }}>
                                            Buah</option>
                                        <option value="Kodi" {{ old('satuan', $alat->satuan) == 'Kodi' ? 'selected' : '' }}>
                                            Kodi</option>
                                        <option value="Gross" {{ old('satuan', $alat->satuan) == 'Gross' ? 'selected' : '' }}>
                                            Gross
                                        </option>
                                        <option value="Lusin" {{ old('satuan', $alat->satuan) == 'Lusin' ? 'selected' : '' }}>
                                            Lusin</option>
                                    </select>
                                    <p><small class="text-muted">Wajib Diisi!</small></p>
                                </div>
