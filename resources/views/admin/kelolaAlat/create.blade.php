...
@section('content')
    <div class="card">
        <div class="card-body">
            <form method="POST" action="{{ url('kelolaAlat') }}" class="form-horizontal" enctype="multipart/form-data"
                id="tambahAlat">
                @csrf
                    ...
                    <div class="col-md-6 mt-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('nama') is-invalid @enderror" id="nama"
                                name="nama" placeholder="Masukkan Nama Alat" value="{{ old('nama') }}" required
                                autofocus>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('harga_satuan') is-invalid @enderror"
                                id="harga_satuan" name="harga_satuan" placeholder="Masukkan Harga Satuan Alat"
