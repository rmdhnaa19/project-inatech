<div class="container-fluid">
    <div class="text-center mb-3">
        <h4 class="mb-4">Transaksi {{ $transaksiAlat->detailAlat->alat->nama }} -
            {{ $transaksiAlat->detailAlat->gudang->nama }}</h4>
    </div>
    <div class="row">
        <div class="col-md-5">
            <div class="image-container text-center" style="position: sticky; top: 20px;">
                ...
                @else
                    <img src="{{ asset('storage/asset_web/No Image Available.png') }}" alt="Foto Alat"
                        class="img-fluid" style="width: auto; height: 30vh;">
                @endif
            </div>
        </div>
