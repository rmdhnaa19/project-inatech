        ...
        <form method="POST" action="{{ url('faseKolam') }}" class="form-horizontal" enctype="multipart/form-data"
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <select 
                                class="choices form-select @error('id_kolam') is-invalid @enderror" 
                                name="id_kolam" 
                                id="id_kolam" 
                                disabled
                            >
                                ...
                                @foreach ($kolam as $item)
                                    <option value="{{ $item->id_kolam }}" 
                                        {{ old('id_kolam', $selectedIdkolam) == $item->id_kolam ? 'selected' : '' }}>
                                        {{ $item->kd_kolam }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <input 
                            ...
                            name="id_kolam" 
                            id="id_kolam_hidden" 
                            value="{{ old('id_kolam', $selectedIdkolam) }}"
                        >
                        @error('id_kolam')
            ...
            <div class="d-flex justify-content-between">
                <button type="button" class="btn btn-sm btn-danger"
                    onclick="window.location.href='{{ route('user.kolam.index') }}'"
