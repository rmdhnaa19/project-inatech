    ...
    public function list(Request $request)
    {
        ...
        return DataTables::of($users)
            ...
            ->addColumn('aksi', function ($user) {
                ...
                $btn .= '<form class="d-inline-block" id="btn-hapus" method="POST" action="'. url('/kelolaPengguna/'.$user->id_user).'">' . csrf_field() . method_field('DELETE') . '<button type="submit" class="btn btn-danger btn-sm" onclick="return confirm(\'Apakah Anda yakin menghapus data ini?\');"><i class="fa-solid fa-trash-can"></i>&nbsp;&nbsp;Hapus</button></form>'; 
                return $btn;
            })
